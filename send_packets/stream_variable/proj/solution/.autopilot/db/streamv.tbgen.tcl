...
set C_modelName {streamv}
set C_modelType { int 1 }
set C_modelArgList {
	{ candin_0_V int 64 regular {pointer 0}  }
	{ candin_1_V int 64 regular {pointer 0}  }
	{ candin_2_V int 64 regular {pointer 0}  }
	{ candin_3_V int 64 regular {pointer 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "candin_0_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "candin.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 0,"step" : 2}]}]}]} , 
 	{ "Name" : "candin_1_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "candin.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 1,"up" : 1,"step" : 2}]}]}]} , 
 	{ "Name" : "candin_2_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "candin.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 2,"up" : 2,"step" : 2}]}]}]} , 
 	{ "Name" : "candin_3_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "candin.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 3,"up" : 3,"step" : 2}]}]}]} , 
...
set portList { 
	...
	{ candin_0_V sc_in sc_lv 64 signal 0 } 
	{ candin_1_V sc_in sc_lv 64 signal 1 } 
	{ candin_2_V sc_in sc_lv 64 signal 2 } 
	{ candin_3_V sc_in sc_lv 64 signal 3 } 
	{ candout_V sc_out sc_lv 64 signal 4 } 
	{ candout_V_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ eventstart sc_in sc_logic 1 signal 5 } 
	{ lastvalid sc_in sc_logic 1 signal 6 } 
	{ first sc_out sc_logic 1 signal 7 } 
	{ first_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ last sc_out sc_logic 1 signal 8 } 
	{ last_ap_vld sc_out sc_logic 1 outvld 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "candin_0_V", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "candin_0_V", "role": "default" }} , 
 	{ "name": "candin_1_V", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "candin_1_V", "role": "default" }} , 
 	{ "name": "candin_2_V", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "candin_2_V", "role": "default" }} , 
 	{ "name": "candin_3_V", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "candin_3_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			{"Name" : "candin_0_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "candin_1_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "candin_2_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "candin_3_V", "Type" : "None", "Direction" : "I"},
			...
			{"Name" : "readidx_V", "Type" : "OVld", "Direction" : "IO"}]},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.streamv_mux_42_67bkb_U1", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	streamv {
		candin_0_V {Type I LastRead 0 FirstWrite -1}
		candin_1_V {Type I LastRead 0 FirstWrite -1}
		candin_2_V {Type I LastRead 0 FirstWrite -1}
		candin_3_V {Type I LastRead 0 FirstWrite -1}
		candout_V {Type O LastRead -1 FirstWrite 3}
		eventstart {Type I LastRead 0 FirstWrite -1}
		lastvalid {Type I LastRead 0 FirstWrite -1}
		first {Type O LastRead -1 FirstWrite 3}
		last {Type O LastRead -1 FirstWrite 3}
		...
		readidx_V {Type IO LastRead -1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	candin_0_V { ap_none {  { candin_0_V in_data 0 64 } } }
	candin_1_V { ap_none {  { candin_1_V in_data 0 64 } } }
	candin_2_V { ap_none {  { candin_2_V in_data 0 64 } } }
	candin_3_V { ap_none {  { candin_3_V in_data 0 64 } } }
