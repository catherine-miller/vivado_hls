...
entity stream_mux_42_67_bkb is
generic (
    ID            :integer := 0;
    NUM_STAGE     :integer := 1;
...
architecture rtl of stream_mux_42_67_bkb is
    -- puts internal signals
    signal sel    : std_logic_vector(1 downto 0);
    -- level 1 signals
    signal mux_1_0    : std_logic_vector(66 downto 0);
    signal mux_1_1    : std_logic_vector(66 downto 0);
    -- level 2 signals
    signal mux_2_0    : std_logic_vector(66 downto 0);
begin
