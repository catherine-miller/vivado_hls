...
set SourceFiles {sc {} c ../../src/header.cc}
set SourceFlags {sc {} c {{}}}
set DirectiveFile /afs/cern.ch/user/m/millerca/vivado_hls/send_packets/write_header/proj/solution/solution.directive
