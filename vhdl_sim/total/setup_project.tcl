create_project test /afs/cern.ch/user/m/millerca/vivado_hls/vhdl_sim/total/test.dir -part xcku15p-ffva1760-2-e -force
...
add_files -norecurse -fileset sources_1  count.vhd
add_files -norecurse -fileset sources_1  streamv.vhd
add_files -norecurse -fileset sources_1  writeheader.vhd
add_files -norecurse -fileset sources_1  streamv_brams_V_0.vhd
add_files -norecurse -fileset sources_1  streamv_mux_42_67bkb.vhd
